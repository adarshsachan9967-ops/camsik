...
export default function AdminBrands() {
  ...
  const handleToggle = (id: string) => setBrandList(prev => prev.map(b => b.id === id ? { ...b, active: !b.active } : b));
  ...
  const handleSave = () => {
    if (editingBrand) {
      ...
      setBrandList(prev => [...prev, { ...form, id: `brand-${Date.now()}`, slug: form.name.toLowerCase(), alt: form.name, modelCount: 0, active: true }]);
    }
    setShowModal(false);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 z-10">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-xs font-bold text-gray-600 mb-1.5 block">Logo URL</label>
