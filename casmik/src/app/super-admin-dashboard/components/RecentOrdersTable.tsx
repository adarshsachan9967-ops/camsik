...
const orders = [
  ...
  { id: 'CSM-2608-4719', customer: 'Sneha Reddy', city: 'Hyderabad', device: 'MacBook Air M3 16GB', service: 'Buy', quote: '₹72,000', status: 'Shipped', partner: 'Casmik Warehouse', pickupDate: '24 Aug 2026', assigned: true },
