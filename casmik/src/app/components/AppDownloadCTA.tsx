...
export default function AppDownloadCTA() {
  ...
  return (
    <section className="py-12 lg:py-16 bg-[#090d16] overflow-hidden relative border-t border-slate-800 text-white">
      {/* Dynamic ambient background glows */}
      <div className="absolute top-1/4 -left-20 w-96 h-96 bg-primary/20 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-10 w-[500px] h-[500px] bg-emerald-500/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8 bg-slate-900/70 border border-slate-800 p-3 rounded-2xl w-fit">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-6 border-t border-slate-800/80">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-slate-300">Instant Spot Payout</span>
              </div>
              <div className="flex items-center gap-2">
                <Truck size={16} className="text-indigo-400 flex-shrink-0" />
                <span className="text-xs font-semibold text-slate-300">Free Doorstep Pickup</span>
              </div>
              <div className="flex items-center gap-2">
                <ShieldCheck size={16} className="text-emerald-400 flex-shrink-0" />
                <span className="text-xs font-semibold text-slate-300">DoD Certified Wipe</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 size={16} className="text-blue-400 flex-shrink-0" />
                <span className="text-xs font-semibold text-slate-300">Fair AI Valuation</span>
              </div>
            </div>
          </div>
