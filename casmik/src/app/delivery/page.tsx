    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-primary/5 flex items-center justify-center p-4">
        <div className="bg-white rounded-3xl shadow-xl p-8 max-w-md w-full text-center border border-gray-100">
          ...
          <h2 className="text-2xl font-black text-gray-900 mb-2">Delivery Agent Login</h2>
          <p className="text-gray-500 text-sm mb-6">
            Please log in with your registered phone number or register as a new delivery agent to accept pickup tasks and earn daily payouts.
          </p>
          <div className="space-y-3">
            ...
            >
              Sign In as Agent <ArrowRight size={16} />
            </Link>
            <Link
              href="/"
