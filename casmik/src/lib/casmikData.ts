...
export const brands: Brand[] = [
  ...
  // Smartphone Brands
  { id: 'brand-apple-phone', categoryId: 'cat-smartphone', name: 'Apple', slug: 'apple-phone', logo: 'https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg', alt: 'Apple iPhone Brand', modelCount: 15, active: true },
  { id: 'brand-samsung-phone', categoryId: 'cat-smartphone', name: 'Samsung', slug: 'samsung-phone', logo: 'https://upload.wikimedia.org/wikipedia/commons/2/24/Samsung_Logo.svg', alt: 'Samsung Galaxy Brand', modelCount: 16, active: true },
  { id: 'brand-google-phone', categoryId: 'cat-smartphone', name: 'Google', slug: 'google-phone', logo: 'https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg', alt: 'Google Pixel Brand', modelCount: 8, active: true },
  { id: 'brand-oneplus-phone', categoryId: 'cat-smartphone', name: 'OnePlus', slug: 'oneplus-phone', logo: 'https://upload.wikimedia.org/wikipedia/commons/8/8a/OnePlus_Logo.svg', alt: 'OnePlus Brand', modelCount: 10, active: true },
  { id: 'brand-xiaomi-phone', categoryId: 'cat-smartphone', name: 'Xiaomi', slug: 'xiaomi-phone', logo: 'https://upload.wikimedia.org/wikipedia/commons/2/29/Xiaomi_logo.svg', alt: 'Xiaomi Brand', modelCount: 12, active: true },

  // Laptop Brands
  { id: 'brand-apple-laptop', categoryId: 'cat-laptop', name: 'Apple', slug: 'apple-laptop', logo: 'https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg', alt: 'Apple MacBook Brand', modelCount: 10, active: true },
  { id: 'brand-dell-laptop', categoryId: 'cat-laptop', name: 'Dell', slug: 'dell-laptop', logo: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Dell_logo_2016.svg', alt: 'Dell Laptop Brand', modelCount: 12, active: true },
  { id: 'brand-hp-laptop', categoryId: 'cat-laptop', name: 'HP', slug: 'hp-laptop', logo: 'https://upload.wikimedia.org/wikipedia/commons/a/ad/HP_logo_2012.svg', alt: 'HP Laptop Brand', modelCount: 10, active: true },
  { id: 'brand-lenovo-laptop', categoryId: 'cat-laptop', name: 'Lenovo', slug: 'lenovo-laptop', logo: 'https://upload.wikimedia.org/wikipedia/commons/b/b8/Lenovo_logo_2015.svg', alt: 'Lenovo Laptop Brand', modelCount: 11, active: true },
  { id: 'brand-asus-laptop', categoryId: 'cat-laptop', name: 'ASUS', slug: 'asus-laptop', logo: 'https://upload.wikimedia.org/wikipedia/commons/2/2e/ASUS_Logo.svg', alt: 'ASUS Laptop Brand', modelCount: 9, active: true },

  // Tablet Brands
  { id: 'brand-apple-tablet', categoryId: 'cat-tablet', name: 'Apple', slug: 'apple-tablet', logo: 'https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg', alt: 'Apple iPad Brand', modelCount: 12, active: true },
  { id: 'brand-samsung-tablet', categoryId: 'cat-tablet', name: 'Samsung', slug: 'samsung-tablet', logo: 'https://upload.wikimedia.org/wikipedia/commons/2/24/Samsung_Logo.svg', alt: 'Samsung Galaxy Tab Brand', modelCount: 8, active: true },
  { id: 'brand-oneplus-tablet', categoryId: 'cat-tablet', name: 'OnePlus', slug: 'oneplus-tablet', logo: 'https://upload.wikimedia.org/wikipedia/commons/8/8a/OnePlus_Logo.svg', alt: 'OnePlus Pad Brand', modelCount: 4, active: true },
  { id: 'brand-lenovo-tablet', categoryId: 'cat-tablet', name: 'Lenovo', slug: 'lenovo-tablet', logo: 'https://upload.wikimedia.org/wikipedia/commons/b/b8/Lenovo_logo_2015.svg', alt: 'Lenovo Tab Brand', modelCount: 5, active: true },
];
